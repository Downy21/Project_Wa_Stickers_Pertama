...
public class StickerPackDetailsActivity extends AddStickerPackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoAd.loadAd(getString(R.string.reward), adreq.build());
        ...
        addButton.setOnClickListener(v -> {
            ...
            videoAd.setRewardedVideoAdListener(new RewardedVideoAdListener() {
                ...
                public void onRewardedVideoAdLoaded() {
                    pDialog.cancel();
                    Toast.makeText(getBaseContext(), "Finish the video to use this sticker", Toast.LENGTH_SHORT).show();
                    videoAd.show();
                }
                ...
                public void onRewardedVideoAdFailedToLoad(int i) {
                    pDialog.cancel();
                    new AlertDialog.Builder(getBaseContext()).setMessage("We can't get resource from server right now").setTitle("Something went wrong").setPositiveButton("Understand", null).create().show();
                    Toast.makeText(getBaseContext(), "Something happened, we can't continue your action", Toast.LENGTH_SHORT).show();
                }
            ...
            if(videoAd.isLoaded()){
                ...
                videoAd.loadAd(getString(R.string.reward), new AdRequest.Builder().build());
                Toast.makeText(getBaseContext(), "Wait for a while, and then click it again", Toast.LENGTH_SHORT).show();
            }
